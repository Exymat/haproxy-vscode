...
import { assertBooleanMatrixValue } from "../../../src/schema/contractHelpers";
...
describe("loadSchema", () => {
  ...
  it("rejects non-array boolean matrix values through the helper contract", () => {
    expect(() => assertBooleanMatrixValue({}, "sample_casts")).toThrow(/sample_casts/);
  });
